...
const zh: LocaleDefinition = {
  ...
  Agents: {
    ...
    localImport: {
      title: '从本地导入 Agent',
      description: '选择单个 Agent 文件，或选择包含多个 Agent 文件的文件夹',
      urlLabel: '',
      urlPlaceholder: '',
      urlHint: '',
      urlRequired: '',
  ...
  Skills: {
    ...
    detail: {
      ...
      version: '版本',
      contents: '内容',
      systemPromptFragment: '系统提示词片段',
      workflowRules: '工作流规则',
      documentation: '文档',
      scriptsCount: (count) => `脚本 (${count} 个文件)`,
      tags: '标签',
    ...
    editor: {
      editTitle: '编辑技能',
      createTitle: '创建新技能',
      editDescription: '更新您的技能信息和内容',
      createDescription: '为您的项目创建新的领域知识技能',
      basicInfo: '基本信息',
      content: '内容',
      documentation: '文档',
      scripts: '脚本',
      ...
      iconUrl: '图标 URL',
      compatibility: '兼容性',
      compatibilityHint: (chars) => `${chars}/500 字符`,
      tags: '标签',
      addTag: '添加',
      tagPlaceholder: '添加标签后按 Enter',
      systemPromptFragment: '系统提示词片段',
      systemPromptHint: '当技能激活时，此内容将被注入到 AI 的系统提示词中',
      workflowRules: '工作流规则',
      workflowHint: '处理此领域的工作指南和最佳实践',
      scriptManagement: '脚本管理',
      scriptDescription: '选择要包含在此技能中的脚本文件。脚本将被复制到技能的 scripts/ 目录。',
      selectScripts: '选择脚本',
      selecting: '选择中...',
      noScripts: '尚未添加脚本。点击"选择脚本"添加脚本。',
      noScriptsHint: '尚未添加脚本。点击"选择脚本"添加脚本。',
      scriptAlreadyAdded: (name) => `脚本 ${name} 已添加`,
      scriptReadFailed: (name) => `读取 ${name} 失败`,
      scriptsAdded: (count) => `已添加 ${count} 个脚本`,
      scriptsSelectFailed: '选择脚本失败',
      scriptRemoveConfirm: (name) => `确定要移除 ${name} 吗？`,
      cancel: '取消',
      update: '更新',
      create: '创建',
      saving: '保存中...',
  ...
  ScheduledTasks: {
    ...
    fields: {
      ...
      agent: '智能体',
      agentPlaceholder: '选择智能体（可选）',
      agentHint: '如未选择，将使用当前智能体',
      project: '项目工作空间',
      projectPlaceholder: '选择项目（可选）',
      projectHint: '如未选择，将使用当前项目',
...
注意：ChatGPT Plus/Pro 订阅与 API 访问是分开的。`,
  ...
  FileTabs: {
    ...
    relativePathCopied: '相对路径已复制到剪贴板',
    fileAddedToChat: '文件已添加到对话',
    failedToAddFileToChat: '添加文件到对话失败',
  },
  ...
  Proxy: {
    ...
    test: {
      title: '代理测试',
      description: '测试代理是否正常工作，通过访问测试URL验证代理IP',
      testUrl: '测试地址',
      currentProxy: '当前使用的代理',
      detectedIp: '检测到的IP',
    },
    errors: {
      hostRequired: '请输入代理服务器地址',
      portRequired: '请输入端口号',
  ...
  Git: {
    ...
    discard: '放弃',
    discardConfirm: '放弃变更?',
    discardDescription: '这将永久放弃此文件的所有变更。 ',
    deleteFile: '删除文件',
    deleteFileConfirm: '删除文件?',
    deleteFileDescription: '这将永久从磁盘删除此文件。此操作无法撤销。',
    generateMessage: 'AI 生成',
    generating: '生成中...',
    refresh: '刷新',
    branch: '分支',
    noBranch: '无分支',
    ...
    searchBranches: '搜索分支...',
    noResults: '未找到结果。',
    switchedToBranch: '已切换到分支',
    switchedToTag: '已切换到标签',
    failedToSwitchBranch: '切换分支失败',
    failedToSwitchTag: '切换标签失败',
    localBranches: '本地分支',
    remoteBranches: '远程分支',
    noBranches: '无分支',
    ...
    fetched: '已从远程获取',
    failedToFetch: '从远程获取失败',
    switchedToRemoteBranch: '已切换到远程分支',
    failedToSwitchRemoteBranch: '切换到远程分支失败',
    pushBranch: '推送分支',
    pushBranchConfirm: '推送分支到远程？',
    pushedBranch: '已推送分支',
    failedToPushBranch: '推送分支失败',
    createTag: '创建标签',
    tagName: '标签名称',
    tagNamePlaceholder: '例如: v1.0.0',
    tagMessage: '标签消息',
    tagMessagePlaceholder: '标签消息（可选）',
    createdTag: '已创建标签',
    failedToCreateTag: '创建标签失败',
    pushTag: '推送标签',
    pushTagConfirm: '推送标签到远程？',
    pushedTag: '已推送标签',
    failedToPushTag: '推送标签失败',
    deleteTag: '删除标签',
    deleteTagConfirm: '删除标签？\n\n这将同时删除本地和远程标签。',
    deletedTag: '已删除标签',
    failedToDeleteTag: '删除标签失败',
    pushAllTags: '推送所有标签',
    mergeBranch: '合并分支',
    mergeBranchTitle: '合并分支到当前分支',
    selectBranchToMerge: '选择要合并的分支...',
    mergeMessage: '合并消息',
    mergeMessagePlaceholder: '合并消息（可选）',
    noFastForward: '禁用快进合并',
    mergedBranch: '已合并分支',
    failedToMergeBranch: '合并分支失败',
    mergeConflict: '检测到合并冲突。请解决冲突后提交。',
    cannotMergeSelf: '不能合并分支到自身',
    selectBranchFirst: '请先选择要合并的分支',
    diffView: '差异视图',
    original: '原始',
    current: '当前',
    additions: '新增',
    deletions: '删除',
    backToChanges: '返回变更列表',
    previousChange: '上一个变更',
    nextChange: '下一个变更',
