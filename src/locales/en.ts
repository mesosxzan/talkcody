...
const en: LocaleDefinition = {
  ...
  Agents: {
    ...
    localImport: {
      title: 'Import Agent from Local',
      description: 'Select a single Agent file, or a folder containing multiple Agent files',
      urlLabel: '',
      urlPlaceholder: '',
      urlHint: '',
      urlRequired: '',
      scanning: 'Importing...',
      invalidUrl: '',
      networkError: 'Failed to import agent.',
      imported: 'imported',
      failed: 'failed',
      import: 'Import',
      close: 'Close',
      ...
      noSelection: 'Please select a file or folder first',
    ...
    detail: {
      ...
      usedTimes: (count) => `Used ${count} times`,
      source: 'Source',
      type: 'Type',
  ...
  Skills: {
    ...
    detail: {
      ...
      version: 'Version',
      contents: 'Contents',
      systemPromptFragment: 'System Prompt Fragment',
      workflowRules: 'Workflow Rules',
      documentation: 'Documentation',
      scriptsCount: (count) => `Scripts (${count} files)`,
      tags: 'Tags',
      availableScripts: 'Available Scripts',
      scriptPreview: 'Script Preview',
      path: 'Path',
      executeWith: 'Execute with',
    ...
    editor: {
      ...
      editDescription: 'Update your skill information and content',
      createDescription: 'Create a new domain knowledge skill for your projects',
      ...
      compatibilityHint: (chars) => `${chars}/500 characters`,
      tags: 'Tags',
      addTag: 'Add',
      ...
      workflowRules: 'Workflow Rules',
      workflowHint: 'Guidelines and procedures for working with this domain',
      scriptManagement: 'Script Management',
      scriptDescription:
        "Select script files to include with this skill. Scripts will be copied to the skill's scripts/ directory.",
      selectScripts: 'Select Scripts',
      selecting: 'Selecting...',
      noScripts: 'No scripts added yet. Click "Select Scripts" to add scripts.',
      noScriptsHint: 'No scripts added yet. Click "Select Scripts" to add scripts.',
      scriptAlreadyAdded: (name) => `Script ${name} is already added`,
      scriptReadFailed: (name) => `Failed to read ${name}`,
      scriptsAdded: (count) => `Added ${count} script${count !== 1 ? 's' : ''}`,
      scriptsSelectFailed: 'Failed to select scripts',
      scriptRemoveConfirm: (name) => `Are you sure you want to remove ${name}?`,
      cancel: 'Cancel',
      update: 'Update',
      create: 'Create',
      saving: 'Saving...',
      saveSuccess: 'Skill updated successfully',
  ...
  ScheduledTasks: {
    ...
    fields: {
      ...
      agent: 'Agent',
      agentPlaceholder: 'Select an agent (optional)',
      agentHint: 'If not selected, uses the current agent',
      project: 'Project Workspace',
      projectPlaceholder: 'Select a project (optional)',
      projectHint: 'If not selected, uses the current project',
...
Note: ChatGPT Plus/Pro subscription is separate from API access.`,
  ...
  Proxy: {
    ...
    global: {
      ...
      enableDesc: 'Use proxy for all network requests',
      url: 'Proxy URL',
      urlPlaceholder: 'http://127.0.0.1:7890 or socks5://127.0.0.1:9050',
      type: 'Proxy Type',
      protocol: 'Protocol',
      host: 'Server Address',
      port: 'Port',
      username: 'Username',
      usernamePlaceholder: 'Proxy authentication username',
      password: 'Password',
      passwordPlaceholder: 'Proxy authentication password',
      preview: 'Preview',
      autoDetect: 'Auto-detect Local Proxy',
      autoDetectDesc: 'Automatically detect local proxy servers',
      noProxy: 'Bypass List',
      ...
      none: 'No proxy detected',
      status: 'Proxy Status',
      noProxyConfigured: 'No proxy configured',
    },
    webSearch: {
      title: 'Web Search Proxy',
      description: 'Configure proxy specifically for web search (overrides global)',
      enable: 'Enable Web Search Proxy',
    ...
    test: {
      title: 'Proxy Test',
      description: 'Test if the proxy is working correctly by accessing a test URL',
      testUrl: 'Test URL',
      currentProxy: 'Current proxy',
      detectedIp: 'Detected IP',
    },
    errors: {
      hostRequired: 'Please enter the proxy server address',
      portRequired: 'Please enter the port number',
      portInvalid: 'Port number must be between 1 and 65535',
    },
    hints: {
      socks5h: 'Recommended for privacy - DNS resolution through proxy',
      portCommon: 'Common ports: 7890 (HTTP), 9050 (SOCKS5), 1080',
      manualPriority:
  ...
  Git: {
    title: 'Git',
    description: 'Manage Git commits and changes',
    commit: 'Commit',
    ...
    discardDescription: 'This will permanently discard all changes in this file.',
    deleteFile: 'Delete File',
    deleteFileConfirm: 'Delete file?',
    deleteFileDescription:
      'This will permanently delete this file from disk. This action cannot be undone.',
    ...
    switchedToTag: 'Switched to tag',
    failedToSwitchBranch: 'Failed to switch to branch',
    failedToSwitchTag: 'Failed to switch to tag',
    ...
    createdBranch: 'Created and switched to branch',
    ...
    deleteBranchDescription: '? This action cannot be undone.',
    deleting: 'Deleting...',
    ...
    failedToFetch: 'Failed to fetch from remote',
    switchedToRemoteBranch: 'Switched to remote branch',
    failedToSwitchRemoteBranch: 'Failed to switch to remote branch',
    pushBranch: 'Push branch',
    pushBranchConfirm: 'Push branch to remote?',
    pushedBranch: 'Pushed branch',
    failedToPushBranch: 'Failed to push branch',
    createTag: 'Create tag',
    tagName: 'Tag name',
    tagNamePlaceholder: 'e.g., v1.0.0',
    tagMessage: 'Tag message',
    tagMessagePlaceholder: 'Tag message (optional)',
    createdTag: 'Created tag',
    failedToCreateTag: 'Failed to create tag',
    pushTag: 'Push tag',
    pushTagConfirm: 'Push tag to remote?',
    pushedTag: 'Pushed tag',
    failedToPushTag: 'Failed to push tag',
    ...
    mergeBranchTitle: 'Merge branch into current',
    selectBranchToMerge: 'Select branch to merge...',
    mergeMessage: 'Merge message',
    mergeMessagePlaceholder: 'Merge message (optional)',
    noFastForward: 'No fast-forward',
    mergedBranch: 'Merged branch',
    failedToMergeBranch: 'Failed to merge branch',
    mergeConflict: 'Merge conflict detected. Please resolve conflicts and commit.',
    cannotMergeSelf: 'Cannot merge a branch into itself',
    selectBranchFirst: 'Please select a branch to merge',
    diffView: 'Diff View',
    original: 'Original',
    current: 'Current',
    additions: 'Additions',
    ...
    changeNavigation: 'Change navigation',
    noChangesToNavigate: 'No changes to navigate',
    cancel: 'Cancel',
    fileStatus: {
      added: 'Added',
      deleted: 'Deleted',
    ...
    messages: {
      stageSuccess: 'File staged',
      unstageSuccess: 'File unstaged',
      ...
      generateSuccess: 'Commit message generated',
      noStagedChanges: 'No staged changes to commit',
      emptyMessage: 'Please enter a commit message',
      stageAllSuccess: 'Files staged',
      unstageAllSuccess: 'Files unstaged',
      pushSuccess: 'Changes pushed',
      pushFailed: 'Failed to push changes',
      pushCancelled: 'Push cancelled',
      pushCancelFailed: 'Failed to cancel push',
      cancelPush: 'Cancel',
    },
    tooltips: {
      unstageAll: 'Unstage all staged files',
      stageAllModified: 'Stage all modified files',
