...
export interface LocaleDefinition {
  ...
  Skills: {
    ...
    detail: {
      ...
      documentation: string;
      scriptsCount: (count: number) => string;
      tags: string;
    ...
    editor: {
      ...
      compatibilityHint: (chars: number) => string;
      tags: string;
      addTag: string;
      ...
      workflowRules: string;
      workflowHint: string;
      scriptManagement: string;
      scriptDescription: string;
      selectScripts: string;
      selecting: string;
      noScripts: string;
      noScriptsHint: string;
      scriptAlreadyAdded: (name: string) => string;
      scriptReadFailed: (name: string) => string;
      scriptsAdded: (count: number) => string;
      scriptsSelectFailed: string;
      scriptRemoveConfirm: (name: string) => string;
      cancel: string;
      update: string;
      create: string;
      saving: string;
  ...
  Git: {
    ...
    switchedToRemoteBranch: string;
    failedToSwitchRemoteBranch: string;
    pushBranch: string;
    pushBranchConfirm: string;
    pushedBranch: string;
    failedToPushBranch: string;
    createTag: string;
    tagName: string;
    ...
    createdTag: string;
    failedToCreateTag: string;
    pushTag: string;
    pushTagConfirm: string;
    pushedTag: string;
    failedToPushTag: string;
    deleteTag: string;
